...
---
=== Exam-7-2-1. PaintableBox class를 구현하라.
...
=== Exam-7-3-1. World에서 Box class를 지원할 수 있도록 추가하라
...
=== Exam-7-1-4. World class의 오브젝트들을 Region class로 단일화시켜 관리토록 바꿔 보자
