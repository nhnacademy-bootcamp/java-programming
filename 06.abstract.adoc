...
image::./image/figure30.png"[title="Vector",align=center]
...
* Source Code
** link:./example/chapter05/src/main/java/com/nhnacademy/exam050301/Vector.java[class Vector]
* 물음
...
* Source Code
** link:./example/chapter05/src/test/java/com/nhnacademy/exam050302/TestVector.java[class TestVector]
...
예를 들어, 여러개의 Vector을 관리할 경우, 다음과 같은 문제가 발생할 수 있다.
...
=== Exam-6-4-1. 단위 이동량stem:[(dx, dy)]을 Vector class로 수정하라
